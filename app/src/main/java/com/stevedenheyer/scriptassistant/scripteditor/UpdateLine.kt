...
class UpdateLine @Inject constructor(private val projectRepository: ProjectRepository,
                                     @IoDispatcher private val ioDispatcher: CoroutineDispatcher) {
    operator suspend fun invoke(line: Line) {
        return coroutineScope { withContext(ioDispatcher) {projectRepository.updateScriptLine(line) }}
    }
}